...
$ocasuid=$_SESSION['ocasuid'];
 ...
 $notestitle=$_POST['syllabustitle'];
 $notesdesc=$_POST['syllabusdesc'];
...
$sql="insert into syllabus(UserID,Subject,SyllabusTitle,SyllabusDescription,File1,File2,File3,File4)values(:ocasuid,:subject,:notestitle,:notesdesc,:file1,:file2,:file3,:file4)";
...
$query->bindParam(':file4',$file4,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Syllabus has been added.")</script>';
echo "<script>window.location.href ='add-syllbus.php'</script>";
  }
  else
    {
                    ...
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Syallbus Title</label>
                                    <input type="text" class="form-control"  name="syllabustitle" value="" required='true'>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">Syallbus Description</label>
                                    <textarea class="form-control"  name="syllabusdesc" value="" required='true'></textarea>
                                </div>
                                <div class="mb-3">

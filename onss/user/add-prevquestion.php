...
$sql="insert into tblprevque (UserID,Subject,PreTitle,PreDescription,File1,File2,File3,File4)values(:ocasuid,:subject,:notestitle,:notesdesc,:file1,:file2,:file3,:file4)";
...
<html lang="en">
<head>
    <title>ONSS || Add Previous Question Paper</title>
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Add  Prev Question Paper</h6>

...
<body>
 <?php include_once('includes/header.php');?>
    ...
    <main>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Our Previous  Question Paper</h1>
                                    <!-- breadcrumb Start-->
       ...
       $ret = "SELECT ID FROM tblprevque";
$query1 = $dbh -> prepare($ret);
$query1->execute();
$results1=$query1->fetchAll(PDO::FETCH_OBJ);
$total_rows=$query1->rowCount();
$total_pages = ceil($total_rows / $no_of_records_per_page);             
$sql="SELECT tblprevque.*,tbluser.* from tblprevque join tbluser on tblprevque.UserID=tbluser.ID LIMIT $offset, $no_of_records_per_page";
                        ...
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                ...
                                <div class="properties__caption">
                                    ...
                                    <h3><?php  echo htmlentities($row->PreTitle);?> By (<?php  echo htmlentities($row->FullName);?>)</h3>
                                    <p><?php  echo htmlentities($row->PreDescription);?>.
